// Lines no. 163 and later lines are very important
// to change carousel images size and margins
...
// Change These two lines Below to change size of images of carosel 
...
// Change These two lines Below to change margin of carosel 

            container.style.marginTop = 0.5 * (window.innerHeight - h -400) + 'px';
            container.style.marginBottom = 0.5 * (window.innerHeight - h -250) + 'px';
